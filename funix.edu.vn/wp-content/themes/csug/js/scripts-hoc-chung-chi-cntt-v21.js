...
(function(){/*
	...
	loop = setInterval(next, loop_delay);
	bslider.addEventListener('mouseover', function(){
		clearInterval(loop);
	});
	bslider.addEventListener('mouseout', function(){
		loop = setInterval(next, loop_delay);
	});
...
(function(){
	// mentors slider
	var bslider = document.getElementById('mentorss-slider');
	var itemsCount = document.querySelectorAll('#mentorss-slider .-cell').length;
	var current = 0;
	...
	// 	loop = setInterval(next, loop_delay);
	// });
	document.querySelector('.mentorss__control .control__next').onclick = next;
	document.querySelector('.mentorss__control .control__prev').onclick = prev;
})();
(function(){
